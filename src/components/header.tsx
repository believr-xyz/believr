...
export function Header() {
  ...
  // Keep track of previous user state to prevent unnecessary updates
  const prevUserRef = useRef(user);

  // Re-render when auth state changes
  useEffect(() => {
    // Only update the key when the user actually changes (login/logout)
  ...
  // If user is authenticated, show the app header, otherwise show the landing page header
  if (user) {
    return (
